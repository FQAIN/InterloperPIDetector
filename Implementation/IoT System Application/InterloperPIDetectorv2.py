...
#Created objects to point to the LED, Button, Buzzer, PIR sensor and PI Camera.
...
def handle(msg):
    ...
    #If the /photo is typed on the telegram bot it starts the motion detection system
    ...
    try:
        ...
        while True:
            ...
            if Alarm_state == True:
                led.off()
                sleep(1)
                #If motion is detected a message would be displayed that there has been motion detetced and turns on the LED and Beeps
                if pir.motion_detected:
                    ...
                    #If button is NOT pressed within 10 seconds the program continues
                        ...
                        #If motion=1 and motionNew=0 
                        if motionNew != motion:
                            #Sets the motionNew = motion 
                            motionNew = motion
